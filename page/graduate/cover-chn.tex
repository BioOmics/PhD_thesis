...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{l l >{\raggedleft}X l}
        分类号：           & \underline{Q811.4}  &
        单位代码：         & \uline{\hfill 10335 \hfill} \\
        密{\quad}级：      & \underline{\ \ \ \ 无\ \ \ \ } &
        学{\quad\quad}号： & \underline{12107157}
    \end{tabularx}
\end{center}
...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{>{\fangsong}l X<{\centering}}
        ...
        {
            % TitleEngLines == 2
            英文论文题目：& \zihao{3} \uline{\hfill Unlocking Telomere-to-Telomere Genome \hfill} \\
            ~            & \zihao{3} \uline{\hfill Architecture and Evolutionary Dynamics \hfill} \\
            ~            & \zihao{3} \uline{\hfill across Hundreds of Plant Species \hfill} \\
        }
    \end{tabularx}
\end{center}
